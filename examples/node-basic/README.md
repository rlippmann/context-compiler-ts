...
Demonstrates compiler-mediated request flow where explicit instructions stay consistent across turns, clarify blocks ambiguous directives, and normal chat continues to the model.
...
That preserves both saved compiler state and pending clarify/confirm continuation state.
